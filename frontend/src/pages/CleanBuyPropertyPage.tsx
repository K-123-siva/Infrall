...
export default function CleanBuyPropertyPage() {
  ...
  const handleSearch = () => {
    ...
    if (propertySubType) params.set('subCategory', propertySubType);
      ...
      <div style={{ maxWidth: 860, margin: '0 auto' }}>
        ...
        <div style={{ background: '#ffffff', borderRadius: 20, boxShadow: '0 16px 48px rgba(0,0,0,0.08)', padding: '36px 40px', border: '1px solid #f1f5f9' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 28 }}>
            ...
            <p style={{ fontSize: 14, color: '#94a3b8', margin: 0 }}>Find your dream home</p>
          </div>

          {/* Divider */}
          <div style={{ height: 1, background: '#f1f5f9', marginBottom: 24 }} />

          {/* Row 1: City + Locality side by side */}
          ...
          <div style={{ marginBottom: 20 }}>
            ...
            <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
              {['All Types', 'Full House', 'Shop', 'Land/Plot', 'Other'].map(type => {
                const val = type === 'All Types' ? '' : type;
                const active = propertySubType === val;
                return (
                  <label key={type} style={{
                    ...
                    <input type="radio" name="propertySubType" value={val}
                      checked={active} onChange={(e) => setPropertySubType(e.target.value)}
          ...
          <div style={{ marginBottom: 28 }}>
            <label style={labelStyle}>BHK Type</label>
            <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
              {bhkTypes.map(bhk => {
                ...
                return (
                  <label key={bhk} style={{
                    ...
                    <input type="checkbox" checked={active} onChange={() => handleBHKToggle(bhk)}
                      style={{ width: 14, height: 14, accentColor: '#3b82f6' }} />
                    {bhk}
                  </label>
                );
          ...
          <button onClick={handleSearch}
            style={{
              ...
              gap: 8, boxShadow: '0 6px 16px rgba(220,38,38,0.3)', transition: 'opacity 0.2s'
            }}
          >
            <Search size={18} />
            Search Properties
